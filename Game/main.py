...
background = pygame.image.load(('Images/bg8.png'))
...
class Player:
    def __init__(self):
        self.image = pygame.image.load(f"Images/player1.png")
...
class Button:
    ...
    def draw(self):
        ...
        display.blit(self.image, self.rect)
        return action
restart_button = Button(width // 2, height // 2, 'Images/restart_btn 3.png')
start_button = Button(width // 2 - 150, height // 2, 'Images/start_btn 3.png')
exit_button = Button(width // 2 + 150, height // 2, 'Images/exit_btn 3.png')
...
class World:
    def __init__(self, data):
        ...
        grass_img = pygame.image.load('images/tile9.png')
        self.tile_list = []
        row_count = 0
        for row in data:
            col_count = 0
